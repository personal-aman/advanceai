    ...
    def post(self, request):
        ...
        for index, segment in enumerate(transcript.segments):
            ...
            prompt_template = (
                ...
                "Objective: Review and select all text passages from interactions between REPs and HCPs that fit the definitions and examples.\n"
                 "Each text passage may belong to MORE THAN ONE OR NONE of the following categories (based on the definitions and examples provided):\n"
